...
if (current_user_can('hs_matrimony_user') || current_user_can('administrator')) {
  if($gender == 'Male'){
    ...
    $this_one = 'Male';
    $details = json_decode(get_user_meta(1027,'haysky_mat_details',true));
      $user = get_userdata(1027);
      $user_meta = get_user_meta(1027);
      ...
      $first_one = '<tr>
        ...
        <a href="'.$href_url.'" target="_blank"><img src="'.$img_url.'"></a>
      </td>
        <td><div style="font-size:120%; line-height: 150%;">
        <b class="user_id">ID: VSB'.$user->ID.'</b><br>
        '.$user->display_name.'
...
<?php
if (current_user_can('hs_matrimony_user')) {
  echo $first_one;
  ...
  foreach ($blogusers as $user) {
    ...
    $details = json_decode(get_user_meta($user->ID,'haysky_mat_details',true));
      ...
      <tr <?php echo $bg; ?>>
        <td style="text-align: center;">'; 
        <a href="<?php echo $href_url; ?>" target="_blank"><img src="<?php echo $img_url; ?>"></a>
      </td>
